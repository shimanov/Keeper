...
namespace ConsoleApp1
{
    public class ExecuteScript : IExecuteScript
    {
        ...
        public void ScriptExport()
        {
            ...
            {
                connection.Open();
                Console.WriteLine("Успешно подключились к БД " + NamePc() + "для выполнения скрипта ReplicaExport");
                ...
                Console.WriteLine("Успешно выполнил скрипт ReplicaExport на БД " + NamePc() + "соединение закрыл");
        ...
        public void ScriptImport()
        {
            ...
            try
            {
                ...
                Console.WriteLine("Успешно подключились к БД " + NamePc() + "для выполнения скрипта ReplicaImport");
